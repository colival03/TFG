...
class ProductController
{
    ...
    public function getProductsByCategory() {
        if (isset($_GET['category'])) {
            ...
            // Usamos el DAO para buscar productos por categoría
            $pDAO = new ProductoDAO();
            $productos = $pDAO->buscarPorCategoria($categoria);
    
            // Verificar si hay productos y cargar la vista
            if (empty($productos)) {
                $mensaje = "No se encontraron productos en la categoría " . htmlspecialchars($categoria);
                include 'vistaProductos'; // Pasamos el mensaje a la vista
            } else {
                include 'vistaProductos'; // Pasamos los productos a la vista
            }
        } else {
            $mensaje = "Categoría no especificada";
            include 'vistaProductos.php'; // Mostramos un mensaje de error
        }
    }
