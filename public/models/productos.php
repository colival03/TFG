...
class ProductoDAO {
     ...
     */
    public function updateProduct($id, $Nombre, $Precio, $Descripcion, $Stock, $id_categoria) {
        $stmt = $this->db_con->prepare("
            UPDATE productos
            SET nombre = :Nombre, precio = :Precio, descripcion = :Descripcion, stock = :Stock, id_categoria = :id_categoria
